  ...
  return (
    <div className="w-full relative">
      ...
      <input
        ...
        placeholder=" "
        type={type}
        className=" peer w-full p-4 pt-6 font-light bg-black bg-opacity-40 border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed pl-9pl-4 border-neutral-300 focus:border-[#09CAF8] "
      />
